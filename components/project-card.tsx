...
export function ProjectCard({ title, description, tags, image, demoUrl, repoUrl }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 pointer-events-none"></div>
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              {/* Isolated button container to prevent group hover interference */}
              <div className="isolate">
                <GradientButton
                  ...
                  width="auto"
                  height="auto"
                  className="text-sm relative z-10 [&:not(:hover)]:group-hover:bg-none [&:not(:hover)]:group-hover:shadow-none"
